// EmbossShader
var EmbossShader = ShaderEffectProgram.extend({
...
EmbossShader.create = function(spriteSize) {
    var shaderProgram = new EmbossShader();
    shaderProgram.initWithString(
        ...
        ShaderFileUtil.loadShaderFromFile(
            ShaderFileUtil.ShaderSpriteFolder + "SHADER_EMBOSS.fsh"
        ),
        spriteSize
    );
