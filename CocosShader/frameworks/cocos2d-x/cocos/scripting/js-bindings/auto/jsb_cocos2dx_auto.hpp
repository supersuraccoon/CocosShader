...
bool js_cocos2dx_Texture2D_initWithData(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_cocos2dx_Grid3D_getVertex(JSContext *cx, uint32_t argc, jsval *vp);
...
void register_all_cocos2dx(JSContext* cx, JS::HandleObject obj);
// modified by supersuraccoon start
bool js_cocos2dx_TiledGrid3D_getTile(JSContext *cx, uint32_t argc, jsval *vp);
bool js_cocos2dx_TiledGrid3D_setTile(JSContext *cx, uint32_t argc, jsval *vp);
bool js_cocos2dx_TiledGrid3D_getOriginalTile(JSContext *cx, uint32_t argc, jsval *vp);
// modified by supersuraccoon end
